...
# By default all these toolchains are registered by the probe_rs_tools_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:probe_rs_tools_toolchain",
    toolchain_type = "@probe_rs_tools//probe_rs_tools:toolchain_type",
)
""".format(
            platform = platform,
